    ...
    \node[anchor=north west, text width=11.0cm, align=justify, font=\ptsansbold\fontsize{9}{10.5}\selectfont, text=gris_foncee] (proj_last) at (#1) {
        \begin{minipage}{\textwidth}
            \begin{itemize}[left=0em, labelsep=0.5em, itemsep=0.05em, align=left, label=\textbullet]
                ...
                \ptsans Étude et état de l'art de convertiseur d'électronique de puissance pour véhicule hybride léger. Analyse et comparaison de différentes topologie de convertiseur, présentés en soutenance technique.
            \end{itemize}
        \end{minipage}
    };
}
...
% ======================================================================
% SECTION : PROFIL — variantes prêtes à l'emploi
% ======================================================================
% Dans le fichier de sélection, choisis-en une avec :
%   \newcommand{\Profil}{\ProfilIngenierieSysteme}
% (ou écris directement un texte sur mesure à la place)

\newcommand{\ProfilIngenierieSysteme}{%
...
\newcommand{\ProfilEmbarqueLogiciel}{%
    Futur ingénieur généraliste orienté systèmes embarqués et logiciel, je recherche un stage de fin d'études en développement embarqué et logiciel critique.
    Mon parcours en électronique de puissance, robotique et développement Python/C++ me permet d'aborder aussi bien la partie matérielle que logicielle des systèmes.
}

\newcommand{\ProfilGeneraliste}{%
    Futur ingénieur généraliste polyvalent, je recherche un stage de fin d'études me permettant de mettre en application mes compétences transverses en électronique, informatique et gestion de projet, acquises au travers de projets d'équipe variés.
}

\newcommand{\ProfilGeneralisteDeux}{%
    Futur ingénieur généraliste polyvalent, je recherche un stage de fin d'études me permettant de mettre en application mes compétences transverses en électronique embarquée, algorithmie et gestion de projet, acquises au travers de projets d'équipe variés (robotique, électronique de puissance, systèmes embarqués). 
    Je souhaite aujourd'hui mettre cette polyvalence au service d'un projet technique ambitieux.
}

% ======================================================================
% RÉSERVE : COMPÉTENCES  &  OUTILS ET LANGAGES
% ======================================================================
% Ces items sont trop courts pour mériter chacun leur propre macro : le
% fichier de sélection définit directement \Competences et \OutilsLangages
% comme une liste de \item. Cette section sert juste de RÉSERVE dans
% laquelle piocher/copier les lignes voulues.
%
% Réserve COMPÉTENCES :
