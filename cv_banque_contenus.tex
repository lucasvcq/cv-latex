    ...
    \node[anchor=north west, text width=10.4cm, align=justify, font=\ptsansbold\fontsize{9}{10.5}\selectfont, text=gris_foncee] (proj_last) at (#1) {
        \begin{minipage}{\textwidth}
            \begin{itemize}[left=0em, labelsep=0.5em, itemsep=0.05em, align=left, label=\textbullet]
                ...
                \ptsans Trajectoire et simulation sous \textbf{RoboDK} / suite Adaxis pour bras Universal Robots. Développement d'un script d'orchestration Python (TCP) et firmware Arduino/RAMPS pour la gestion de la tête d'impression et des sécurités thermiques.
            \end{itemize}
        \end{minipage}
    };
}
